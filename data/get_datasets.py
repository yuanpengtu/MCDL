...
def get_datasets(dataset_name, train_transform, train_transform_noform, test_transform, args):
    """
    ...
    datasets_noform = get_dataset_f(train_transform=train_transform_noform, test_transform=test_transform,
                            train_classes=args.train_classes,
                            prop_train_labels=args.prop_train_labels,
                            split_train_val=False)
    ...
    train_dataset_noform = MergedDataset(labelled_dataset=deepcopy(datasets_noform['train_labelled']),
                                  unlabelled_dataset=deepcopy(datasets_noform['train_unlabelled']))
    test_dataset = datasets['test']
    unlabelled_train_examples_test = deepcopy(datasets['train_unlabelled'])
    unlabelled_train_examples_test.transform = test_transform
    return train_dataset, train_dataset_noform, test_dataset, unlabelled_train_examples_test, datasets
